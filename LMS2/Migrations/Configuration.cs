namespace LMS2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LMS2.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var modules = new[] {
                new Module { ModuleName = "Communism1", Description = "Planned economy", StartDate = new DateTime(2017, 12, 04, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                ...
                new Module { ModuleName = "Communism2", Description = "Modern bourgeois society", StartDate = new DateTime(2018, 01, 01, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[8].Id},
                new Module { ModuleName = "Communism3", Description = "The proletariat", StartDate = new DateTime(2018, 01, 28, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[8].Id},
                new Module { ModuleName = "SheepFarming1", Description = "Market possibilities and Strategies", StartDate = new DateTime(2018, 01, 28, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                ...
                new Module { ModuleName = "SheepFarming2", Description = "Matching Nutrition for Age & Stage", StartDate = new DateTime(2018, 01, 01, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[9].Id},
                new Module { ModuleName = "SheepFarming3", Description = "Pasture, Parasites and Predators", StartDate = new DateTime(2018, 01, 28, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[9].Id},
                new Module { ModuleName = "SheepFarming4", Description = "Health Management", StartDate = new DateTime(2018, 01, 29, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[9].Id},
                new Module { ModuleName = "SheepFarming5", Description = "Financial Considerations of Sheep Farming and a quick look at Housing and Handling Systems", StartDate = new DateTime(2018, 02, 05, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[9].Id},
                new Module { ModuleName = "SheepFarming6", Description = "Record Keeping, identification methods, and selection methods to meet your goals", StartDate = new DateTime(2018, 02, 19, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ...
                    CourseId = courses[9].Id},
                new Module { ModuleName = "BerryProduction1", Description = "Strawberries", StartDate = new DateTime(2018, 01, 29, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ModuleInfo = "cultural systems of strawberries; recommended varieties; pest management.",
                    CourseId = courses[10].Id},
                new Module { ModuleName = "BerryProduction2", Description = "Raspberries and Blackberries", StartDate = new DateTime(2018, 02, 05, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
                    ModuleInfo = "cultural systems of bramble crops; recommended varieties; pest management.",
                    CourseId = courses[10].Id},
                new Module { ModuleName = "BerryProduction3", Description = "Post-harvest and marketing", StartDate = new DateTime(2018, 02, 19, 0, 0, 0), EndDate = new DateTime(2017, 12, 04, 0, 0, 0),
...
EndDate = new DateTime(2017, 12, 04, 8, 0, 0),
